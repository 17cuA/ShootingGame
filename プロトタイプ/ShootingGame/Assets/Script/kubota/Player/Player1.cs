...
public class Player1 : character_status
{
	...
	private void SpeedUp()
	{
		...
		particle.Play();
		Voice_Manager.VOICE_Obj.Voice_Active(Obj_Storage.Storage_Data.PowerUpVoice[0]);
	...
	private void ActiveMissile()
	{
		...
		effect.transform.position = gameObject.transform.position;
		particle.Play();
		Voice_Manager.VOICE_Obj.Voice_Active(Obj_Storage.Storage_Data.PowerUpVoice[1]);
		SE_Manager.SE_Obj.SE_Active_2(Obj_Storage.Storage_Data.audio_se[16]);
	}
	//二連をできるように
	private void ActiveDouble()
	{
		...
		effect.transform.position = gameObject.transform.position;
		particle.Play();
		Voice_Manager.VOICE_Obj.Voice_Active(Obj_Storage.Storage_Data.PowerUpVoice[2]);
		SE_Manager.SE_Obj.SE_Active_2(Obj_Storage.Storage_Data.audio_se[16]);
	}
	//レーザーを打てるように
	private void ActiveLaser()
	{
		...
		particle.Play();
		//----------------------------------------------------------------------
		Voice_Manager.VOICE_Obj.Voice_Active(Obj_Storage.Storage_Data.PowerUpVoice[3]);
		SE_Manager.SE_Obj.SE_Active_2(Obj_Storage.Storage_Data.audio_se[16]);
	...
	private void ActiveShield()
	{
		...
		shield_Effect.Play();
		//------------------------------------------------------------------------
		Voice_Manager.VOICE_Obj.Voice_Active(Obj_Storage.Storage_Data.PowerUpVoice[5]);
		SE_Manager.SE_Obj.SE_Active_2(Obj_Storage.Storage_Data.audio_se[16]);
	...
	private void CreateBit()
	{
		...
		Voice_Manager.VOICE_Obj.Maltiple_Active_Voice(Obj_Storage.Storage_Data.PowerUpVoice[4]);     //ボイス
	...
	private void Init_speed()
	{
		...
		Voice_Manager.VOICE_Obj.Voice_Active(Obj_Storage.Storage_Data.PowerUpVoice[7]);		//パワーアップの音声を流す
