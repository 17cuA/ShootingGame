...
public class UI_Shadow : BaseMeshEffect, IParameterTexture
#if UNITY_EDITOR
...
#pragma warning restore 0414
	...
	static readonly List<UI_Shadow> tmpShadows = new List<UI_Shadow>();

	protected override void OnEnable()
	{
		base.OnEnable();

		_uiEffect = GetComponent<UI_Effect>();
		if (_uiEffect)
		{
			ptex = _uiEffect.ptex;
			ptex.Register(this);
	...
	public override void ModifyMesh(VertexHelper vh)
	{
		...
		GetComponents<UI_Shadow>(tmpShadows);
		...
		//================================
		{
			_uiEffect = _uiEffect ?? GetComponent<UI_Effect>();
