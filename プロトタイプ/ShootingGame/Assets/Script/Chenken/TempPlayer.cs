...
public class TempPlayer : MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		PowerManager.Instance.AddCheckFunction(PowerManager.Power.PowerType.LASER,   () => { return player1.hp < 1 || player1.bullet_Type == Player1.Bullet_Type.Double; }, null);
		PowerManager.Instance.AddCheckFunction(PowerManager.Power.PowerType.SHIELD,  () => { return player1.shield < 1; }, null);
	}
