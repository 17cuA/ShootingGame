...
public class LaserScript : MonoBehaviour
{
	...
	public Renderer start_rend;
	public Renderer end_rend;

	void Start()
	{
		start_rend = start.GetComponent<Renderer>();
		end_rend = end.GetComponent<Renderer>();
	}
	...
	void Update()
	{
		...
		// Place things
		// -- Gather some data
		float startSpriteWidth = start_rend.bounds.size.x;
		float endSpriteWidth = 0f;
		if (end != null) endSpriteWidth = end_rend.bounds.size.x;
