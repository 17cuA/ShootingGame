...
namespace Costom
{
	...
	public class GameClear : MonoBehaviour
	{
		...
		void Update()
		{
			...
			// PressButtonの点滅
			if (displayInfo == EDisplayInformation.eResult || displayInfo == EDisplayInformation.eResultToRanking /*|| RankingDisplay.instance.IsDecision*/)
			{
			...
			// 入力を受けたらScene移行
			if ((Input.anyKeyDown && rankingDisplay.IsDecision) && !Input.GetKey(KeyCode.LeftAlt) && !Input.GetKey(KeyCode.LeftAlt) && !Input.GetKey(KeyCode.F4) && !Input.GetKey(KeyCode.LeftControl))
			{
