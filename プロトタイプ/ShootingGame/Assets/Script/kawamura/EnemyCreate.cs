...
public class EnemyCreate : MonoBehaviour
{
	...
	public GameObject enemy_Beelzebub_Group_Four;
    ...
    void Start()
    {
		...
		enemy_Beelzebub_Group_Four = Resources.Load("Enemy/Enemy_Beelzebub_Group_Four") as GameObject;
